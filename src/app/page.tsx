...
export default function Home() {
  return (
    <main className="overflow-x-hidden m-auto relative md:max-w-[1440px] shadow-lg">
      <div className="bg-main overflow-x-hidden inset-0 mt-[-240px] md:mt-[-250px] ml-[-100px] md:ml-[-400px] z-auto lg:w-[1900px]  md:w-[1500px] w-[900px] h-[700px] md:h-[800px] absolute rotate-[-12deg] top-0 bg-gradient-to-r from-[#265d58] to-[#6d9c99] md:from-[#265d58] md:to-[#467975] lg:to-[#497c79]"></div>
      <Header />
